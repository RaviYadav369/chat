    ...
    <>
      <div className="flex flex-col h-full bg-background absolute dark:bg-bgDarkMain relative z-10">
        <div className="m-2 flex flex-col flex-1 space-y-2 overflow-y-auto mb-2">
          ...
          <button
            className="inline-flex items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input hover:bg-accent hover:text-accent-foreground py-2 h-10 w-full justify-start px-4 shadow-none transition-colors md:flex"
            id="history-popup-button"
          >
            <svg
              width="15"
              height="15"
            ...
            <span className="md:flex">History</span>
          </button>
          <div className="mt-2">
            <button className="inline-flex items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input hover:text-accent-foreground py-2 h-10 w-full justify-start px-4 shadow-none transition-colors hover:bg-zinc-200/40 dark:bg-bgDarkMain dark:hover:bg-accent md:flex">
              <svg
              ...
              <span className="ml-2 md:flex">Image To App</span>
            </button>
          </div>
          <button className="inline-flex items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input hover:bg-accent hover:text-accent-foreground py-2 mobile-sidenav-item-hide h-10 w-full justify-start px-4 shadow-none transition-colors md:flex mt-2">
            <svg
              width="15"
              height="15"
              viewBox="0 0 15 15"
            ...
            <span className="ml-2 md:flex">Agents</span>
          </button>
          <button className="inline-flex items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input hover:bg-accent hover:text-accent-foreground py-2 mobile-sidenav-item-hide h-10 w-full justify-start px-4 shadow-none transition-colors md:flex">
            <svg
              width="15"
            ...
            <span className="ml-2 md:flex">BLACKBOX IDE</span>
          </button>
          <button className="inline-flex items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input hover:bg-accent hover:text-accent-foreground py-2 mobile-sidenav-item-hide h-10 w-full justify-start px-4 shadow-none transition-colors md:flex">
            <svg
              width="15"
            ...
            <span className="ml-2 md:flex">API Platform</span>
          </button>
          <button className="inline-flex items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input hover:bg-accent hover:text-accent-foreground py-2 mobile-sidenav-item-hide h-10 w-full justify-start px-4 shadow-none transition-colors md:flex">
            <svg
              width="15"
            ...
            <span className="ml-2 md:flex">Docs</span>
          </button>
          <button className="inline-flex items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input hover:bg-accent hover:text-accent-foreground py-2 h-10 mt-2 w-full justify-start px-4 shadow-none transition-colors md:flex">
            <svg
              width="15"
              height="15"
              viewBox="0 0 15 15"
            ...
            <span className="md:flex">Partnership</span>
          </button>
          <button className="inline-flex items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input hover:bg-accent hover:text-accent-foreground py-2 mobile-sidenav-item-hide h-10 w-full justify-start px-4 shadow-none transition-colors md:flex">
            <svg
              width="15"
            ...
            <span className="ml-2 md:flex">Careers</span>
          </button>
          <button className="inline-flex items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input hover:bg-accent hover:text-accent-foreground py-2 h-10 w-full justify-start px-4 shadow-none transition-colors md:flex mt-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="md:flex ml-2">Log Out</span>
          </button>
        </div>
        <div className="flex items-center gap-3 p-3 border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="flex h-8 w-8 shrink-0 select-none items-center justify-center rounded-full bg-muted/50 text-sm font-medium uppercase text-muted-foreground"></div>
          <div className="flex flex-col min-w-0">
            <span className="truncate text-sm font-medium"></span>
            <span className="truncate text-xs text-muted-foreground">
              gasene3269@endibit.com
            </span>
          </div>
        </div>
        <div className="absolute bottom-4 right-4 sm:hidden">
          <button className="group relative inline-flex shrink-0 items-center gap-[1px] rounded-full bg-zinc-100 px-2.5 py-1 text-sm text-black transition-colors duration-200 hover:bg-zinc-950 hover:text-zinc-50 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 256 256"
              fill="currentColor"
